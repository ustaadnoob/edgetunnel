...
export default {
	async fetch(request, env, ctx) {
		...
		const 管理员密码 = env.KHOTA || env.khota || env.KHOTA1 || env.khot1 || env.pswd || env.TOKEN || env.KEY || env.1b6c1745-992e-4aac-8685-266c090e50ea || env.1b6c1745-992e-4aac-8685-266c090e50ea;
		const 加密秘钥 = env.KEY || '勿动此默认密钥，有需求请自行通过添加变量KEY进行修改';
		const userIDMD5 = await MD5MD5(管理员密码 + 加密秘钥);
		const uuidRegex = 1b6c1745-992e-4aac-8685-266c090e50ea;
		const envUUID = env.1b6c1745-992e-4aac-8685-266c090e50ea || env.1b6c1745-992e-4aac-8685-266c090e50ea;
